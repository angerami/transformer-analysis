...
class HeadAnalyzer:
    ...
    def __init__(self, config):
        ...
        #initialize data
        self.data = { weight_type : {'weight_type' : weight_type} for weight_type in config.weight_type }
    ...
    def fill_stats(self, weight_name, x_arr):
        self.data[weight_name].update({ k : f(x_arr) for k, f in self.stats_functions.items()})
